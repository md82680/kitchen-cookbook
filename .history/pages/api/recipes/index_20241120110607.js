...
const handleFileUpload = async (file) => {
  if (process.env.NODE_ENV === 'production') {
    console.log('Production environment detected - using default image');
    return {
      imageUrl: "/images/default-recipe.jpg",
      imageName: "default-recipe.jpg"
    };
  }

  console.log('Development environment - handling local file upload');
