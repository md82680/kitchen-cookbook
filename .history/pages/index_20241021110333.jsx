        ...
        <>
          ...
          <div className={styles.recipeSection} id="recipes">
            ...
            <div className={styles.recipeCards}>
              <div >
                <CategoryCard title="Breakfast" link="/breakfast" imageSrc="/images/breakfast.jpg" />
              </div>
              <div>
                <CategoryCard title="Dinner" link="/dinner" imageSrc="/images/dinner.jpg" />
              </div>
              <div >
                <CategoryCard title="Dessert" link="/dessert" imageSrc="/images/dessert.jpg" />
              </div>
            </div>
          </div>
        </>
